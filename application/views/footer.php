        ...
        <footer class="no-print">
          ...
          <div class="pull-right">
            ...
            Nakliye | Fatura Sorgulama - Designed by <a href="https://nakliye.com">Nakliye</a>
    ...
    <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                $("#headinfobutton").click(function() {
                    ...
                    $.ajax({
                        ...
                        url: "/index.php/Nakliye/headinfo_update",
                ...
                $("#fooinfobutton").click(function() {
                    ...
                    $.ajax({
                        ...
                        url: "/index.php/Nakliye/fooinfo_update",
                ...
                $("#useful_info_reset").click(function() {
                    ...
                    $.get('/assets/useful_info_default.txt', function(data) {
            ...
            $('#veriKaydet').click(function(){
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/sonucKaydet",
                    ...
                    success: function(data) {
                        ...
                        setTimeout(function(){$(location).attr('href', '/index.php/Nakliye/view_fatura?id='+data)},1250);
            ...
            $('#veriGuncelle').click(function(){
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/sonucGuncelle",
            ...
            $("#editDues").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/dues_series_update",
            ...
            $("#editBulkCargoType").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/bulk_cargo_type_update",
            ...
            $("#editGarbage").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/garbage_update",
            ...
            $("#editWarfage").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "/index.php/Nakliye/warfage_update",
            ...
            $("#editNotariel").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/update_notariel",
            ...
            $("#editTrfreight").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/tr_freight_chamber_update",
            ...
            $("#editforeignfreight").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/foreign_freight_chamber_update",
            ...
            $("#editforeignpass").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/foreign_pass_update",
            ...
            $("#editAssosiation").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/assosiation_update",
            ...
            $("#editimpCovertime").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/impcovertime_update",
            ...
            $("#editexpCovertime").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/expcovertime_update",
            ...
            $("#editAgency").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/agency_update",
            ...
            $("#login-button").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/giris_yap",
            ...
            $("#kullaniciOlusturBtn").click(function() {
                ...
                if (user_pw1 == user_pw2) {
                    ...
                    $.ajax({
                        ...
                        url: "/index.php/Nakliye/mail_kontrol",
                        ...
                        success: function(data) {
                            ...
                            if (data == 0) {
                                ...
                                $.ajax({
                                    ...
                                    url: "/index.php/Nakliye/create_users",
                ...
                .then((willDelete) => {
                    ...
                    if (willDelete) {
                        ...
                        $.ajax({
                            ...
                            url: "/index.php/Nakliye/delete_users",
            ...
            $('body').on('click', '#kullanici_duzenle', function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/get_single_user",
                            ...
                            success: function(data) {
                                ...
                                if (data == 0) {
                                    ...
                                    $.ajax({
                                        ...
                                        url: "/index.php/Nakliye/update_users",
            ...
            $("#editaliagatarife").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/update_aliagatarife",
            ...
            $("#editizmirtarife").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/update_izmirtarife",
            ...
            $("#editGtf_series").click(function() {
                ...
                $.ajax({
                    ...
                    url: "/index.php/Nakliye/gtf_series_update",
                ...
                .then((willDelete) => {
                    ...
                    if (willDelete) {
                        ...
                        $.ajax({
                            ...
                            url: "/index.php/Nakliye/delete_fatura",
                            ...
                            success: function(data) {
                                ...
                                swal("Proforma başarıyla silindi.", "Kullanıma hazır! Sayfa yenilenecek.", "success");
                        ...
                        swal("Proforma silinmedi! Korunuyor.");
                    ...
                    if (willDelete) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                swal("Proformalar başarıyla silindi.", "Kullanıma hazır! Sayfa yenilenecek.", "success");
                        ...
                        swal("Proformalar silinmedi! Korunuyor.");
