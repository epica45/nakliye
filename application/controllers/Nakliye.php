...
class Nakliye extends CI_Controller {
...

	{
		...
		$this->load->view('fatura_sorgulama');
...

	{
		...
		$this->load->view('fatura_sonuc',$view_info);
...

	{
		...
		$single = $this->nakliye_model->get_single_fatura($get["id"]);
		...
		$this->load->view('view_fatura',$view_info);
...

	{
		...
		$list = $this->nakliye_model->get_faturalist();
	...
	{
		$data = $this->nakliye_model->get_faturalist2();
        echo json_encode($data);
	}
...

	{
		...
		$result = $this->nakliye_model->delete_fatura($data["id"]);
